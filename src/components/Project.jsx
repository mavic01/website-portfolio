    ...
    <section id="projects" className="py-20 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Here’s a look at some of the projects I’ve built. Each one reflects my
          growth, creativity, and problem-solving as a frontend developer.
        </p>
          ...
          {projects.map((project, key) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="tet-muted-foreground text-sm mb-4">
                  {project.description}
                </p>
